...
export default class Feedback extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            TextBox: "",
            TextArea: "",
            Div:'<div class="alert alert-warning alert-dismissible fade show" role="alert"><strong>Error!</strong> You should check in on some of those fields above.<button type="button" style="background:none;border:none" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>',
            ...
            <>
                <div className="FeedbackMain" id="FeedbackHomePage">
                    <div className="FormBlock">
                        ...
                        <button type="submit" className="btn btn-success mb-2" onClick={() => this.onClickFunction()} name="ButtonFeedback">Send Feedback</button>
                        <div id="AlertDiv">
